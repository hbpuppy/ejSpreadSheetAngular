...
export class RTEComponent extends EJComponents<any, any> implements ControlValueAccessor
{
	...
	@Input('cleanupFilterOption') cleanupFilterOption_input: any;
	...
	@Input('pasteCleanup') pasteCleanup_input: any;
	...
	@Input('cleanupFilterOption.listConversion') cleanupFilterOption_listConversion_input: any;
	@Input('cleanupFilterOption.cleanCSS') cleanupFilterOption_cleanCSS_input: any;
	@Input('cleanupFilterOption.removeStyles') cleanupFilterOption_removeStyles_input: any;
	@Input('cleanupFilterOption.cleanElements') cleanupFilterOption_cleanElements_input: any;
