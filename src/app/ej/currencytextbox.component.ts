...
export const CurrencyTextboxValueAccessor: any = {
	provide: NG_VALUE_ACCESSOR,
	useExisting: forwardRef(() => CurrencyTextboxComponent),
	multi: true
};
...
@Component({
	...
	providers: [CurrencyTextboxValueAccessor]
})
...
export var EJ_CURRENCYTEXTBOX_COMPONENTS: Type<any>[] = [CurrencyTextboxComponent
];
